...
export function FilterBar({
  ...
  return (
    <section className="mb-16 mt-8 rounded-xl border border-border bg-[var(--card-bg)] px-5 py-3 shadow-[0_2px_10px_-2px_rgba(0,0,0,0.05)] backdrop-blur-md" aria-label="年级筛选">
